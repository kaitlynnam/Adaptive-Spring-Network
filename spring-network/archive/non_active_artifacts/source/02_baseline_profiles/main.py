...
def run_demo(topology_path=DEFAULT_TOPOLOGY_PATH, relax_internal=True):
    ...
    output_dir = PROJECT_ROOT / "plots" / "profile_conditioned_passive" / "demos"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to a topology JSON file, for example spring-network/topologies/profile_conditioned_passive/internal_fan_20_spring_model.json.",
    )
    parser.add_argument(
        "--no-relax-internal",
        action="store_true",
