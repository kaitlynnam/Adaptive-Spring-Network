...
from passive_mechanics import PASSIVE_NETWORK_PRESETS
...
def main():
    ...
    parser.add_argument("--network", choices=sorted(PASSIVE_NETWORK_PRESETS), default="fan")
    ...
    preset = PASSIVE_NETWORK_PRESETS[args.network]
